...
observations = Year.shift(0,1).fill(DOWN).is_not_blank().is_not_whitespace() -tab.excel_ref('B21')
Dimensions = [
            HDim(Year,'Year',DIRECTLY,ABOVE),
            HDim(sap,'NI Household Energy',DIRECTLY,LEFT ),
            HDimConst('Unit','sap scale'),  
            HDimConst('Measure Type','Rate'),
            HDimConst('NI Household Description','Northern Ireland Household energy SAP Rating')
