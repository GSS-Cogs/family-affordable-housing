...
observations = htype.fill(DOWN).is_not_blank().is_not_whitespace() - tab.excel_ref('K24')
Dimensions = [
            HDim(Year,'Year', DIRECTLY,LEFT),
            HDim(htype,'NI Housing Specification',DIRECTLY,ABOVE),
            HDimConst('Unit','gbp'),  
            HDimConst('Measure Type','GBP Total'),
            HDimConst('NI Owner Occupied Housing Description','Northern Ireland Home Movers Lending and Affordability')
