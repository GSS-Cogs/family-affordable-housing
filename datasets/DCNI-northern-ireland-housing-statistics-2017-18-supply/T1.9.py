...
observations = Year.fill(DOWN).is_not_blank().is_not_whitespace() - tab.excel_ref('G18')
Dimensions = [
            ...
            HDimConst('NI Housing Description','SHDP New Social Housing Dwelling Completions')
